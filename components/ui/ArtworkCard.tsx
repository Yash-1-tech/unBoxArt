  ...
  return (
    <Link href={`/artwork/${id}`} className={`artwork-card block group ${className}`}>
        ...
        {!imgError && image ? (
          ...
          >
            <div className="text-center p-4">
              ...
              <p className="text-xs text-gray-500 font-medium line-clamp-2">{title}</p>
            </div>
          </div>
        )}
      ...
      <div className="pt-2.5 pb-4">
        <h3 className="text-[13px] font-semibold text-gray-900 leading-snug overflow-hidden" style={{ display: '-webkit-box', WebkitLineClamp: 1, WebkitBoxOrient: 'vertical' }}>
          {title}
        </h3>
