  ...
  return (
    <div>
      ...
      <div className="max-w-[1280px] mx-auto px-4 lg:px-8 py-16">
        <h2 className="text-2xl font-bold text-center text-gray-900 mb-10">Contact Us:</h2>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-12">
          {[
            { Icon: MapPin, label: 'Locate Us.', lines: ['P 12, Wing, 432, Ghivlikar, Otla,', 'Boi Market Street, Virar (West),', '401 303, Maharashtra, India.'] },
            { Icon: Phone, label: 'Call Us', lines: ['+91 9403214091', '+91 0506-42491'] },
            { Icon: Mail, label: 'Mail Us', lines: ['info@unboxartsandfriends.com', 'help@unboxartsandfriends.com'] },
            ...
            <div key={label} className="text-center">
              ...
              {lines.map((line, i) => <p key={i} className="text-xs text-gray-500">{line}</p>)}
            </div>
          ))}
        </div>
