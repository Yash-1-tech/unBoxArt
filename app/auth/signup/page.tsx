  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-16 px-4">
      <div className="bg-white w-full max-w-md p-8 shadow-sm">
        ...
        {success && (
          <p className="text-xs text-green-600 bg-green-50 border border-green-200 px-3 py-2 mb-4 rounded">
            {success}
          </p>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div>
            <label className="block text-xs text-gray-500 mb-1.5">I am joining as</label>
            <select
              name="role"
              value={form.role}
              onChange={handleChange}
        ...
        <p className="text-center text-xs text-gray-400 mt-5">
          ...
          <Link href="/auth/signin" className="text-[#e63329] font-medium hover:underline">
            Sign In
          </Link>
        </p>
      </div>
